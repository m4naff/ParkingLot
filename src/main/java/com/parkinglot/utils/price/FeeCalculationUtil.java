...
import com.parkinglot.exception.priceLIst.PriceListNotFoundException;
...
public class FeeCalculationUtil {
    ...
    private static final Map<VehicleType, FeeCalculationStrategy> VEHICLE_TYPE_FEE_CALCULATION = Map.of(
            VehicleType.SEDAN, new SedanFeeCalculationStrategy(),
     ...
     */
    private static boolean isWithInTimeInterval(final PriceEntity priceEntity, final long spentTime) {
     ...
     */
    private static long getSpentTime(final ParkEntity parkEntity) {
